...
export const protocols: Protocol[] = [
  {
    ...
    description:
      "Comprehensive metabolic weight loss — GLP-1 medication (semaglutide or tirzepatide), labs, monthly provider check-ins, and ongoing dose monitoring.",
    includes: [
      ...
      "Progress tracking & re-test scheduling",
    ],
  ...
  },
  {
    ...
    door: "optimize",
    tagline: "NAD+ · Labs · Quarterly monitoring",
    description:
      "Complete performance medicine baseline — NAD+ injection protocol, Ultimate 360 biomarker panel, and quarterly monitoring check-ins to track and adjust.",
    includes: [
      "Ultimate 360 Panel",
